...
public class Act_SignIn extends Activity implements OnClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (this.mCurrentPersonName == null){
    ...
    public void onConnected(Bundle connectionHint) {
        String currentPersonName = mPlusClient.getCurrentPerson() != null
                ...
                mCurrentPersonName= currentPersonName;
        Log.w("nevin", "---------"+mPlusClient.getAccountName()+"-----------");
