...
public class Act_Product extends FragmentActivity  {
...
//		setContentView(R.layout.act_project);
		if (savedInstanceState == null) {
			...
			Frg_Product_List details = new Frg_Product_List();
            details.setArguments(getIntent().getExtras());	// Pass the intent to fragment
