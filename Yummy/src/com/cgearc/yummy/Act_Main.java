...
public class Act_Main extends Activity implements SearchCompletedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mProgressBar = (ProgressBar)this.findViewById(R.id.pr_act_main);
        ...
        mDrawerToggle = new ActionBarDrawerToggle(
            ...
            public void onDrawerSlide(View drawerView, float slideOffset) {
            	...
            	BaseFragment fragment = (BaseFragment)
                        Act_Main.this.getFragmentManager().findFragmentById(R.id.content_frame);
    ...
    private void selectItem(int position) {
        ...
        default:
            ...
            args.putInt(BaseFragment.ARG_PLANET_NUMBER, position);
            fragment.setArguments(args);
